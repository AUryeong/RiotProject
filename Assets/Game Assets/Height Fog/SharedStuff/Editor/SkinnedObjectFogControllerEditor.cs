...
[CustomEditor(typeof(SkinnedObjectFogController))]
public class SkinnedObjectFogControllerEditor : Editor
{
    private GUIStyle            boxStyle;
    private SkinnedObjectFogController targetInstance;
    ...
    public override void OnInspectorGUI()
    {
        ...
        targetInstance    = (SkinnedObjectFogController)target;
