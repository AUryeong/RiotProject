...
[AddComponentMenu("SKGames/Skinned Object Fog Controller")]
[DisallowMultipleComponent]
[ExecuteInEditMode]
[RequireComponent(typeof(SkinnedMeshRenderer))]
public class SkinnedObjectFogController : MonoBehaviour
{
    public Color mainColor;
    [Header("Main fog configuration")] public ObjectFogController.FogSpace fogSimulationSpace;
    ...
    private void OnEnable()
    {
        if (mpb != null && renderer != null)
        {
            ...
            fogSimulationSpace = (ObjectFogController.FogSpace)Enum.Parse(typeof(ObjectFogController.FogSpace),
