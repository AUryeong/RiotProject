...
namespace Lobby
{
    public class LobbyUIStage : LobbyUIActiveLink
    {
        ...
        private Button stageSelectLeftButton;
        [SerializeField] private Image stageSelectRight;
        private Button stageSelectRightButton;
        ...
        protected override void Awake()
        {
            ...
            stageSelectLeftButton = stageSelectLeft.GetComponent<Button>();
            stageSelectRightButton = stageSelectRight.GetComponent<Button>();
            ...
            stageSelectLeftButton.onClick.RemoveAllListeners();
            stageSelectLeftButton.onClick.AddListener(PrevStage);
            
            stageSelectRightButton.onClick.RemoveAllListeners();
            stageSelectRightButton.onClick.AddListener(NextStage);
        }
        ...
        private void NextStage()
        {
            ...
            mainStageSlot.RectTransform.DOAnchorPosX(0, UI_DRAG_MOVE_DURATION).SetEase(Ease.OutBack).OnComplete(() =>
            {
                ...
                for (int i = 0; i < 3; i++)
                {
                    if (SaveManager.Instance.GameData.GetStageData(stageSelectIndex, i).isBuy)
                        selectableBgmIndexList.Add(i);
                }

                bgmSelectIndex = selectableBgmIndexList.SelectOne();
